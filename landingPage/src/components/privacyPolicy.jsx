...
const SECTIONS = [
  {
    ...
    content: [
      { subtitle: '1.1 Account Information', text: 'When you create a Vego account, we collect your name, phone number, email address (optional), travel agency name(optional), and city(optional). We use a WhatsApp one-time OTP to verify your phone number. This information is required to set up your profile and provide you with our trip-booking and fleet-management services.' },
      ...
      { subtitle: '1.4 Personal Data You Provide About Other People', text: 'Vego lets you add personal data about individuals other than yourself — including your customers (name, phone number, address, pending balances) and your drivers(name, phone number, address, licence details). For this third-party information, your travel agency is the data controller and VengurlaTech acts only as a data processor on your behalf — we store and process it solely to deliver the Vego service to you and never use it for our own purposes. You are responsible for ensuring you have a lawful basis and, where required by applicable law, the consent of these individuals before adding their information to Vego, and for informing them about how their data is used. Any customer, driver can exercise their rights (access, correction, or deletion) by contacting the agency that added them, or by writing to us at support@vengurlatech.com — we will forward such requests to the relevant agency and assist as needed.' },
    ],
  },
  {
    title: '2. How We Use Your Information',
    content: [
      { subtitle: '2.1 Providing the Service', text: 'Your data is used to operate Vego — to create bookings, calculate fares and distances, manage your vehicles and drivers, track payments and expenses, generate reports. Your profile is used to personalise your experience and to label exported reports and documents.' },
  ...
  },
  {
    ...
    content: [
      { subtitle: '3.1 Data Storage', text: 'Your data is stored on secure servers operated by VengurlaTech. Vego is a mobile app for Android. Data you create is synced to our servers so it is available across your devices and protected against device loss.' },
