...
class _VehicleDriverPageState extends ConsumerState<VehiclePage>
  ...
  void initState() {
    ...
    Future.microtask(() {
      ref.read(tripBookingViewModelProvider.notifier).vehicleList(ref.read(tripBookingViewModelProvider).agencyId?? '');
      ref.read(tripBookingViewModelProvider.notifier).driverList(ref.read(tripBookingViewModelProvider).agencyId?? '');
    });
  }
