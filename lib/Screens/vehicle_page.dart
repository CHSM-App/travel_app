...
//             result['message']?.toString() ?? '${v.name} deleted successfully',
...
//                 ref.read(addVehicleViewModelProvider).error ??
//                 'Cannot delete yet',
//           ),
//           backgroundColor: _C.red,
//         ),
...
//                             // ),
//                             ListView.builder(
//   padding: const EdgeInsets.fromLTRB(16, 16, 16, 100), // ✅ IMPORTANT
//   itemCount: vehicles.length,
//   itemBuilder: (context, index) {
//     return _vehicleCard(vehicles[index], index);
//   },
// )
//                           ),
//                         ],
