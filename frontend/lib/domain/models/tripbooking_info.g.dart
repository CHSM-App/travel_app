...
TripBooking _$TripBookingFromJson(Map<String, dynamic> json) => TripBooking(
  ...
  fuelcharges: (json['fuelcharges'] as num?)?.toDouble(),
  startDateTime: TripBooking._dateFromJson(json['startdatetime'] as String?),
  endDateTime: TripBooking._dateFromJson(json['enddatetime'] as String?),
  ...
  isreturntrip: (json['is_return_trip'] as num?)?.toInt(),
);
...
Map<String, dynamic> _$TripBookingToJson(TripBooking instance) =>
    <String, dynamic>{
      ...
      'fuelcharges': instance.fuelcharges,
      'startdatetime': TripBooking._dateToJson(instance.startDateTime),
      'enddatetime': TripBooking._dateToJson(instance.endDateTime),
      'bookingdate': TripBooking._dateToJson(instance.bookingdate),
      'status': instance.status,
      'Customerid': instance.customerid,
      'tripcharges': instance.tripcharges,
      'agency_id': instance.agencyId,
      'is_return_trip': instance.isreturntrip,
    };
