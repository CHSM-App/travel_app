...
class AddVehicleState {
  ...
  AddVehicleState copyWith({
    ...
    return AddVehicleState(
      ...
      fetchTripsByVehicleId:
          fetchTripsByVehicleId ?? this.fetchTripsByVehicleId,
...
class AddVehicleViewModel extends StateNotifier<AddVehicleState> {
  ...
  AddVehicleViewModel(this.ref, this.usecase) : super(const AddVehicleState());
  ...
  Future<dynamic> uploadVehicleDocument(
    ...
    try {
      ...
      final response = await usecase.uploadVehicleDocument(
        rcDocuments,
        vehicleId.toString(),
        agencyId,
      );
